...
public enum FixedType implements TokenTyped {
  ...
  public final FixedType.TypeKind kind;
  public final FixedType.ValueFormat valueFormat; // only for number-related types

  private FixedType(int tokenType, FixedType.TypeKind kind, FixedType.ValueFormat valueFormat) {
    this.tokenType = tokenType;
    this.kind = kind;
    this.valueFormat = valueFormat;
  }

  private FixedType(int tokenType, FixedType.TypeKind kind) {
